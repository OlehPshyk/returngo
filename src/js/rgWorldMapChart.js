...
const rgWorldMapChart = () => {
  const containerWorldMap = document.getElementById('world-map-chart');
  if (containerWorldMap) {
    ...
    const annualPopulation = new FusionCharts({
      type: "world", // Map type
      width: "80%", // Width of the chart
      height: "40%", // Height of the chart  
      dataFormat: "json", // Data Type
      renderAt: "world-map-chart", //container where the chart will render
      dataSource: {
        // Map Configuration
        chart: {
          caption: "",
  ...
  //       linkedchart: {
  //         chart: {
  //           caption: "North America Worldwide",
  //           subcaption: "",
  //           numbersuffix: "",
  //           captionalignment: "left",
  //           theme: "fusion",
